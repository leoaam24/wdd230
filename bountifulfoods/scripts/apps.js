const mediaSmall = window.matchMedia("(max-width: 699px)");

mediaSmall.addEventListener('change', screenSizeSmall);

screenSizeSmall(mediaSmall);

function screenSizeSmall(eventSmall) {
    if (eventSmall.matches) {
